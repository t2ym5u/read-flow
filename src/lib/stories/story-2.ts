...
const story: Story = {
    ...
    keyVocabulary: [
      { word: "bookshop", translation: "librairie", example: "The bookshop appeared only at midnight." },
      ...
      { word: "floated", translation: "flottaient", example: "Thousands of books floated in the air." },
      { word: "destiny", translation: "destin", example: "Each book contains a different destiny." },
      { word: "glowed", translation: "brillaient", example: "The pages glowed softly as he opened the book." },
      { word: "faded", translation: "s'estompa", example: "The world around him faded away." }
    ],
    grammarTips: [
      {
        title: "Past Perfect",
        explanation: "Le past perfect (had + participe passé) décrit une action antérieure à une autre dans le passé.",
    ...
    summary: "Tom découvre une librairie magique qui n'apparaît qu'à minuit. À l'intérieur, des milliers de livres flottent dans les airs. Un vieil homme lui explique que chaque livre contient un destin différent. Tom en choisit un, et quand il relève les yeux, la librairie a disparu.",
    sentences: [
      {
