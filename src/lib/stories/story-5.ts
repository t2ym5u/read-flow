...
const story: Story = {
    ...
    keyVocabulary: [
      ...
      { word: "ingredients", translation: "ingrédients", example: "We need all the ingredients first." },
    ...
    grammarTips: [
      ...
      },
      {
        ...
        examples: ["First, get the ingredients.", "Then, mix them together.", "Finally, cook the pancakes."]
      }
    ],
    summary: "Un père apprend à sa fille Lily à faire des pancakes. Ils suivent la recette ensemble, étape par étape, et partagent un délicieux petit-déjeuner en famille.",
    sentences: [
      {
