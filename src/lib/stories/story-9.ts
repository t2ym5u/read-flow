...
const story: Story = {
	...
	grammarTips: [
		{
			...
			explanation:
				"En anglais, on utilise le past simple pour raconter une histoire au passé, action par action.",
			examples: ["The crowd cheered.", "He kicked the ball.", "The referee blew the whistle."],
		},
		{
			title: "Phrases exclamatives",
			explanation:
				"Les phrases exclamatives expriment une émotion forte, souvent avec 'What a...!' ou 'How...!'.",
	...
	summary:
		"L'équipe locale des Falcons joue la finale du championnat contre les Panthers. Menés au score, ils ne baissent pas les bras. Dans les dernières minutes, le capitaine marque un but spectaculaire qui leur donne la victoire.",
	sentences: [
		{
