...
const story: Story = {
    ...
    keyVocabulary: [
      ...
      { word: "grateful", translation: "reconnaissant", example: "I am grateful for this experience." },
      { word: "homesick", translation: "nostalgique", example: "Sometimes I feel homesick." },
      { word: "perspective", translation: "perspective", example: "This trip changed my perspective." },
      { word: "cherish", translation: "chérir", example: "I will cherish these memories forever." },
      { word: "fascinating", translation: "fascinant", example: "The culture is absolutely fascinating." }
    ],
    grammarTips: [
      {
        title: "Past Perfect",
        explanation: "Le past perfect (had + participe passé) décrit une action terminée avant une autre action passée.",
        examples: ["I had never seen such a beautiful temple before.", "She had always dreamed of visiting Japan."]
      },
      {
        title: "Registre formel vs informel",
        explanation: "Le registre formel utilise des structures plus complexes et un vocabulaire soutenu. Les lettres mélangent souvent les deux.",
        examples: ["I am writing to share my experiences. (formel)", "You won't believe what happened! (informel)", "I would like to tell you about... (formel)"]
      },
      {
        title: "Exprimer son opinion",
        explanation: "Différentes formules permettent d'exprimer une opinion de façon nuancée.",
        examples: ["In my view, the food is extraordinary.", "I believe that travel changes people.", "It seems to me that every culture has something to teach us."]
      }
    ],
    summary: "Claire, une étudiante française au Japon, écrit à son amie Léa pour partager ses découvertes : les temples de Kyoto, les coutumes locales, la nourriture, les défis culturels et le mal du pays. Elle réalise que voyager a profondément changé sa vision du monde.",
    sentences: [
      {
