...
const story: Story = {
	...
	keyVocabulary: [
		...
		{ word: "shelter", translation: "abri", example: "I give shelter to many animals." },
		{
			word: "ancient",
			translation: "ancien",
			example: "I am an ancient tree, three hundred years old.",
		},
	...
	grammarTips: [
		{
			...
			explanation:
				"Le present perfect (have/has + participe passé) relie le passé au présent. On l'utilise pour des expériences de vie.",
			examples: [
				"I have seen many winters.",
				"I have watched children grow up.",
				"I have stood here for three hundred years.",
			],
		},
		{
			title: "Ordre des adjectifs",
			explanation:
				"En anglais, les adjectifs suivent un ordre : opinion, taille, âge, couleur, origine.",
			examples: ["A beautiful old oak tree.", "Bright green leaves.", "A small brown squirrel."],
		},
	],
	summary:
		"Un vieux chêne de trois cents ans raconte sa vie à travers les saisons : le printemps avec ses bourgeons, l'été plein de vie, l'automne coloré et l'hiver calme. Il a été témoin de générations d'enfants, d'animaux et de changements.",
	sentences: [
		{
