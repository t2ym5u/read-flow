...
const story: Story = {
    ...
    keyVocabulary: [
      ...
      { word: "rainbow", translation: "arc-en-ciel", example: "A beautiful rainbow appeared in the sky." },
    ...
    summary: "Sophie se réveille un matin de pluie et est d'abord triste. Mais elle met ses bottes, prend son parapluie et sort. Elle saute dans les flaques, rencontre un chien joueur, et quand la pluie s'arrête, un magnifique arc-en-ciel apparaît.",
    sentences: [
      {
