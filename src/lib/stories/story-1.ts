...
const story: Story = {
	...
	keyVocabulary: [
		...
		{ word: "attic", translation: "grenier", example: "The door in the attic was locked." },
		{
			...
			example: "There was a mysterious door upstairs.",
		},
		{
			word: "trembling",
			translation: "tremblant",
			example: "She picked it up with trembling hands.",
		},
	],
	grammarTips: [
		{
			title: "Past Simple",
			explanation:
				"Le past simple décrit des actions terminées dans le passé. On ajoute souvent '-ed' aux verbes réguliers.",
			examples: [
				"Emma walked through the garden.",
				"She searched under every bush.",
				"She picked it up.",
			],
		},
		{
			...
			examples: [
				...
				"Something was shining near the fountain.",
			],
		},
	],
	summary:
		"Emma cherche la clé dorée de sa grand-mère dans le jardin. Elle la trouve près de la fontaine et court vers la maison pour ouvrir la porte mystérieuse du grenier.",
	sentences: [
		{
