...
const story: Story = {
	...
	keyVocabulary: [
		...
		{ word: "delay", translation: "retard", example: "There was an unexpected delay." },
		{
			...
			example: "The last passenger ran onto the train.",
		},
		{ word: "schedule", translation: "horaire", example: "He checked the schedule on his phone." },
		{
			word: "destination",
			translation: "destination",
			example: "His destination was three hours away.",
		},
	...
	grammarTips: [
		{
			...
			explanation:
				"Le third conditional (If + had + participe passé, would have + participe passé) décrit une situation irréelle dans le passé.",
			examples: [
				"If he had left earlier, he would have caught the train.",
				"If she hadn't called, he would have missed it.",
			],
		},
		{
			title: "Past Perfect Continuous",
			explanation:
				"Le past perfect continuous (had been + -ing) décrit une action en cours avant un moment passé.",
			examples: [
				"He had been running for ten minutes.",
				"She had been waiting at the station since nine.",
			],
		},
		{
			title: "Inversions emphatiques",
			explanation:
				"Pour un effet dramatique, on peut inverser le sujet et l'auxiliaire après certains adverbes.",
			examples: [
				"Never had he run so fast.",
				"Barely had he sat down when the train moved.",
				"Not once did he stop to rest.",
			],
		},
	],
	summary:
		"Lucas doit absolument prendre le dernier train pour retrouver sa sœur à l'hôpital. Retardé par un embouteillage, il court désespérément à travers la gare. Grâce à l'aide d'une inconnue et d'un contrôleur bienveillant, il attrape le train in extremis et arrive à temps.",
	sentences: [
		{
