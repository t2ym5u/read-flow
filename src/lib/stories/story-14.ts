    ...
    grammarTips: [
      {
        ...
        examples: ["She used to sing in her bedroom.", "He used to play guitar at school.", "They used to go to festivals every summer."]
      },
      {
        title: "Discours indirect",
        explanation: "Pour rapporter les paroles de quelqu'un, on utilise le discours indirect avec un recul de temps.",
        examples: ["She said (that) she was nervous.", "He told her (that) she could do it.", "They said (that) it was amazing."]
      }
    ],
    summary: "Aisha, une lycéenne timide, adore chanter mais n'a jamais osé se produire en public. Son ami Théo l'inscrit à un concours au festival de musique local. Malgré sa peur, elle monte sur scène et chante sa propre chanson. La foule l'acclame et elle réalise qu'elle peut réaliser ses rêves.",
    sentences: [
      {
    ...
    quiz: [
      {
        ...
        options: ["Elle n'aimait pas chanter", "Elle était trop timide", "Elle chantait mal", "Elle n'avait pas le temps"],
        correct: 1
      },
      {
