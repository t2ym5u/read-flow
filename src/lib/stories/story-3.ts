...
const story: Story = {
	...
	keyVocabulary: [
		{
			...
			example: "He spent twenty years perfecting his invention.",
		},
		{
			word: "temporal",
			translation: "temporel",
			example: "The temporal displacement device was ready.",
		},
		{
			word: "coordinates",
			translation: "coordonnées",
			example: "He set the coordinates for London, 1895.",
		},
		{
			word: "malfunctioning",
			translation: "dysfonctionner",
			example: "His return device was malfunctioning.",
		},
		{
			word: "stranded",
			translation: "bloqué",
			example: "He was stranded in the nineteenth century.",
		},
		{
			word: "predicament",
			translation: "situation difficile",
			example: "If anyone could understand his predicament...",
		},
		{
			word: "carriages",
			translation: "calèches",
			example: "Horse-drawn carriages clattered past.",
		},
	],
	grammarTips: [
		{
			title: "Past Perfect",
			explanation:
				"Le past perfect (had + participe passé) place une action avant une autre dans le passé.",
			examples: [
				"He had spent twenty years perfecting his invention.",
				"He had done it — he had actually traveled through time!",
			],
		},
		{
			title: "Voix passive",
			explanation:
				"La voix passive met l'accent sur l'action plutôt que sur celui qui la fait (be + participe passé).",
			examples: [
				"The crystal core had been cracked.",
				"He was stranded in the nineteenth century.",
			],
		},
		{
			...
			examples: [
				"If anyone could understand his predicament, it would be the scientists.",
				"If he could find the right materials, he might repair it.",
			],
		},
	],
	summary:
		"Le professeur Stevens teste sa machine à voyager dans le temps et arrive à Londres en 1895. Mais son dispositif de retour est cassé. Bloqué au XIXe siècle, il part chercher de l'aide auprès des scientifiques de la Royal Institution.",
	sentences: [
		{
	...
	quiz: [
		...
		},
		{
			...
			options: [
				"Il est perdu",
				"Le dispositif de retour ne fonctionne pas",
				"Il est blessé",
