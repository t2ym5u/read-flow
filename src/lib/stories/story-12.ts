...
const story: Story = {
	...
	keyVocabulary: [
		...
		{
			word: "envelope",
			translation: "enveloppe",
			example: "A thick envelope was under the table.",
		},
		{
			word: "disappear",
			translation: "disparaître",
			example: "The stranger disappeared into the crowd.",
		},
		{
			word: "investigate",
			translation: "enquêter",
			example: "She decided to investigate the mystery.",
		},
	],
	grammarTips: [
		{
			...
			explanation:
				"Le first conditional (if + present, will + verbe) exprime une situation probable dans le futur.",
			examples: [
				"If I find the envelope, I will call the police.",
				"If she comes back, I will ask her.",
			],
		},
		{
			title: "Verbes de perception",
			explanation:
				"Les verbes 'see', 'hear', 'notice', 'watch' sont suivis d'un complément + infinitif sans 'to' ou participe présent.",
			examples: [
				"She saw him leave.",
				"I heard someone whispering.",
				"She noticed a man sitting alone.",
			],
		},
		{
			title: "Connecteurs logiques",
			explanation:
				"Les connecteurs organisent les idées dans un récit : d'abord, ensuite, cependant...",
			examples: [
				"First, she ordered a coffee.",
	...
	summary:
		"Nina, une étudiante, passe tous les matins au même café. Un jour, elle remarque un homme mystérieux qui laisse une enveloppe épaisse sous sa table avant de partir. Intriguée, elle enquête et découvre que l'enveloppe contient des lettres d'amour perdues destinées à la propriétaire du café.",
	sentences: [
		{
