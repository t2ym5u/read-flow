...
const story: Story = {
	...
	keyVocabulary: [
		...
		{ word: "bridge", translation: "pont", example: "He walked across the old bridge." },
		{
			word: "relieved",
			translation: "soulagé",
			example: "Lucas felt relieved when he found his way.",
		},
	],
	grammarTips: [
		{
		...
		},
		{
			...
			explanation:
				"'Could you...?' et 'Excuse me...' sont des formules de politesse pour demander de l'aide.",
			examples: [
		...
		},
		{
			...
			explanation:
				"Les prépositions indiquent la position ou la direction : at, on, in, near, across, along.",
			examples: [
				"Turn left at the corner.",
				"The hotel is on Park Street.",
				"Walk across the bridge.",
			],
		},
	],
	summary:
		"Lucas, un jeune Français, arrive à Londres et se perd. Il demande son chemin à plusieurs personnes, découvre des monuments célèbres en route, et finit par trouver son hôtel grâce à l'aide d'une vieille dame.",
	sentences: [
		{
