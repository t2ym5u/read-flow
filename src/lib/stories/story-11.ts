...
const story: Story = {
	...
	grammarTips: [
		{
			...
			examples: [
				...
				"There is a butterfly on the rose.",
			],
		},
		{
	...
	summary:
		"Lily emménage dans une vieille maison et découvre un portail caché dans le mur du jardin. Derrière, elle trouve un jardin secret magnifique avec des fleurs, un étang et des papillons. Elle décide d'en prendre soin chaque jour.",
	sentences: [
		{
