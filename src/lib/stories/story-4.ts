...
const story: Story = {
    ...
    grammarTips: [
      {
        ...
        explanation: "On utilise le present simple pour décrire des habitudes et des actions régulières.",
    ...
    summary: "Sophie fait ses courses au marché. Elle achète des fruits, des légumes et du pain frais. Elle découvre un nouveau fromage et rentre chez elle satisfaite.",
    sentences: [
      {
